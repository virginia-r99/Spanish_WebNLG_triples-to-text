...
def verbalize_triple(device, tokenizer, model, triples, prompt, messages = None):
    ...
    generated_text_without_input = generated_text[len(tokenizer.decode(inputs[0], skip_special_tokens=True))-1:]  # Remove input part
...
for model_name in models:
    ...
    for mode, prompt, message, file_suffix in [("zero-shot", base_prompt, None, "zero_shot")]:
        ...
        # Save results
        output_path = f"./output_fine_tuned/{model_name}_Instruct_data.json"
